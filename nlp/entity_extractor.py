...
KEYWORD_PATTERNS = {
    ...
    # 'DISK_FULL': r'disk\s*full|디스크\s*풀|No\s*space\s*left|ENOSPC|디스크\s*부족|꽉\s*찼|디스크\s*꽉|용량\s*부족',
    'DISK_FULL':          r'disk\s*full|디스크\s*풀|No\s*space\s*left|ENOSPC|디스크\s*부족|꽉\s*찼|용량\s*부족',
